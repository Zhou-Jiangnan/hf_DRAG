...
def main():
    plotter1 = Plotter(height=3.4, aspect=4/3, num_cols=3, legend_spacing=0.08, subplot_title_spacing=0.36)
    ...
    plotter2 = Plotter(height=4, aspect=3/2, num_cols=1, legend_spacing=0.06, subplot_title_spacing=0.35)
    plotter2.plot(
        data_path="./figures/data/aqh_vs_peer_llama_mmlu.csv",
        plot_type="bar",
        x="# Peers",
    ...
    plotter2.add_legend(legend_cols=3)
    plotter2.save_or_show("./figures/output/aqh_vs_peer_2.pdf")
